...
const STRINGS = {
  en: {
    ...
    settings:'Settings',brandName:'Brand Name',brandLogo:'Business Logo',brandLogoHint:'Any image accepted, auto-converted to PNG (max 300×150px).',
...
`,
  ...
  id: {
    ...
    settings:'Pengaturan',brandName:'Nama Brand',brandLogo:'Logo Usaha',brandLogoHint:'Format gambar apa pun, otomatis diubah ke PNG (maks 300×150px).',
