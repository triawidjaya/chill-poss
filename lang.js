...
const STRINGS = {
  en: {
    ...
    settings:'Settings',brandName:'Brand Name',
    ...
    alertExcelFail:'Excel export failed!',alertSettingsSaved:'Settings saved.',
...
`,
  ...
  id: {
    ...
    settings:'Pengaturan',brandName:'Nama Brand',
    ...
    alertExcelFail:'Gagal export Excel!',alertSettingsSaved:'Pengaturan berhasil disimpan.',
